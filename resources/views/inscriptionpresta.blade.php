...
@endif
  ...
  <form action="{{ route('inscriptionpresta.submit') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="form">
...
<option value="Zouan-Hounien">Zouan-Hounien</option>
   ...
   <div class="inputfield">
    ...
    <select name="metier"class="input" id="metier">
      <option value="#"></option>
    ...
    <div class="inputfield">
      ...
      <div class="col col-md-12 form-group">
       ...
       <div class="inputfield">
        <label for="langues">Langues ou ethnies :</label>
        <input type="text" class="input" placeholder="Langues ou ethnies" id="langues" name="langue">
         </div>
           <div class="inputfield">
            <label>Sexe</label>
            <div class="custom_select">
              <select name="sexe" class="input" id="sexe">
        ...
        <div class="inputfield">
            ...
            <input type="password" class="input" id="passe" name="password">
             ...
             <div class="inputfield">
              ...
              <textarea name="description"class="input" style="width: 93%;" id="description" cols="30" rows="4"></textarea>
             </div>
      <div class="inputfield">
