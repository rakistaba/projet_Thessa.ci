...
<option value="Zouan-Hounien">Zouan-Hounien</option>
        ...
        <div class="inputfield">
            ...
            <input  id="passe" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
            @error('password')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="inputfield">
            ...
            <input  type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" id="passe">
         </div> 
      <div class="inputfield">
