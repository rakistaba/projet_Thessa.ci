      ...
      <div class="container">
        ...
        <section class="row content-header">
            <div class="header-title col-md-11">
              <h1 class="logo-caption"><i class="fa fa-edit" style="color: #002f6d;"></i><span class="tweak" style="color:#002f6d;"> Changer mot de passe</span></h1>
          ...
          <div class="row col col-md-6">
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                ...
                <input id="old_password" type="password" class="form-control" placeholder="ancien mot de passe" onblur="checkAdminPassword(this.value, 'old_password_error');">
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                ...
                <input id="password" type="password" class="form-control" placeholder="mot de passe" style="max-height: 100px;">
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                <label class="font-weight-bold" for="confirm_password">Confirmer nouveau mot de passe :</label>
                <input id="password" type="password" class="form-control" placeholder="confirmer mot de passe">
            ...
            <div class="row col col-md-12 m-auto" id="change">
              ...
              <div id="change_button" class="col col-md-4 form-group float-right">
                <button class="btn form-control font-weight-bold" onclick="changePassword();"style="background-color: #deceff;color: #002f6d;">Confirmer</button>
              </div>
              <!--div id="password_button" class="col col-md-4 form-group float-right">
                <a href="profile.html" class="btn  form-control font-weight-bold" style="background-color: #deceff;color: #002f6d;">Profile</a>
              </div-->
            </div>
